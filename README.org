...
This configuration is tailored to achieve these ends, in accordance with my personal tastes and preferences. Additionally, I semi-frequently build from the master branch of Emacs, so my configuration may include settings to options not packaged in officially released Emacs versions yet.
