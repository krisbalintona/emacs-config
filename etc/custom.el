...
(custom-set-variables
 ...
 '(package-selected-packages
   '(abridge-diff ace-window activities adaptive-wrap agitate all-the-icons
                  ...
                  cm-mode compile-multi compile-multi-nerd-icons cond-star
                  consult-compile-multi consult-xref-stack corfu-prescient
                  cursory darkroom default-text-scale denote diminish dired-hist
                  diredfl dumber-jump eat editorconfig eglot-booster
                  ...
                  hugoista hyprlang-ts-mode info-colors inspector jinx just-mode
                  just-ts-mode keychain-environment kind-icon kv lazy-guard lice
                  ligature lin lorem-ipsum lsp-bridge marginalia mermaid-mode
                  ...
                  org-contrib org-edna org-make-toc org-mem org-mime org-ml
                  org-mode org-modern org-node org-project-capture org-remark
                  org-review org-roam-ql org-roam-ui org-web-tools outli ox-hugo
                  package-build package-lint-flymake paren-face pcmpl-args
                  pdf-tools peg persist-state powerthesaurus pulsar puni python
                  rainbow-mode realgud recursion-indicator savefold
                  saveplace-pdf-view scratch show-font smart-mark so-long
                  soap-client stillness-mode sudo-edit suggest svg
                  system-packages tempel tempel-collection tmr tramp
 ...
 '(package-vc-selected-packages
   '((org-mem :url "https://github.com/meedstrom/org-mem.git")
 ...
 '(safe-local-variable-values
   '((eval setq-local org-archive-location
           (expand-file-name "archive/slip_box.org_archive::* From %R"
                             org-directory))
