...
(custom-set-variables
 ...
 '(package-selected-packages
   '(activities arei astute bui cape citar-org-node cl-generic cond-star
                ...
                hotfuzz jinx lin magit-popup mixed-pitch no-littering
                notmuch-addr ntlm ol-notmuch olivetti on orderless
                org-contrib org-hide-drawers org-mime org-modern
                org-ql org-review org-roam-folgezettel org-web-tools
                orgmdb outli package-upgrade-guard paren-face persid
                powerthesaurus pulsar puni python setup smart-mark
                so-long soap-client svg tablist tempel timeout
                track-changes tramp try use-package vc-jj verilog-mode
