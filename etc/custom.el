...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window agitate astute avy cape citar-denote corfu-prescient cursory
                darkroom denote-explore elisp-demos eros exec-path-from-shell
                fontaine gcmh ht inspector keychain-environment kind-icon lin
                magit marginalia mermaid-mode modus-themes no-littering
                notmuch-addr notmuch-transient ob-mermaid ol-notmuch olivetti on
                orderless org-appear org-contrib org-mime org-modern outshine
