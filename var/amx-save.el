...
(
 ...
 (highlight-function-calls-mode . 3)
 (helm-M-x . 1)
 (helm-occur . 1)
 (helm-apropos . 1)
 (counsel-apropos . 3)
 ...
 (outline-promote . 1)
 (outline-demote . 1)
 (bug-hunter-init-file . 17)
 (project-find-file . 1)
 (flycheck-status-emoji-mode . 2)
 (global-prettier-mode . 2)
 (global-prettify-symbols-mode . 1)
 (server-start . 1)
 (outshine-narrow-to-subtree . 1)
 (consult-file-externally . 2)
 (amx . 2)
 (amx-mode . 5)
 (ivy-rich-mode . 2)
 (all-the-icons-ivy-rich-mode . 2)
)
