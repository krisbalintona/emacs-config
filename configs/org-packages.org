...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (defun kb/org-face-setup ()
      ...
      (if (not (string-equal (car custom-enabled-themes) (cdr (car heaven-and-hell-themes))))
      ...
      ;; (set-face-attribute 'org-link nil :foreground "MediumPurple3" :bold nil :italic t :font kb/variable-pitch-font :height 145 :underline nil) ; Managaed by org-roam
