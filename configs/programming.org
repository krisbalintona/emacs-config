...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    :hook (;;(prog-mode . lsp-deferred) ; Lsp-mode only when buffer is visible
           ...
           (lsp-mode . kb/lsp-mode-setup))
    :commands (lsp lsp-deferred) ; Defer until either of these commands are run
    :preface
    (defun kb/lsp-mode-setup ()
      "Set breadcrumb format and show breadcrumbs at the top of the window."
...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    ...
    (kb/leader-keys
      "of" '(flycheck-list-errors :which-key "List flycheck errors")
      )
    )
#+END_SRC
