...
#+begin_src emacs-lisp
  (use-package consult
    ...
    :config
    ;; Show more information for certain functions. These functions can see what is
    ;; seen from consult-annotate-alist
    (add-hook 'selectrum-mode 'consult-annotate-mode)
