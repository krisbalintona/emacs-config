...
- Not sure if this looks through literate configs?
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package keyfreq
    ...
    :hook ((after-init . keyfreq-mode)
           (after-init. keyfreq-autosave-mode t))
    :custom
    (keyfreq-folder (concat no-littering-var-directory "keyfreq"))
    (keyfreq-excluded-commands '(self-insert-command ; Commands not to be logged
                                 ;; forward-char
                                 ;; backward-char
                                 ;; previous-line
                                 ;; next-line
