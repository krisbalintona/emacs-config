...
#+BEGIN_SRC emacs-lisp
  (setq kb/default-font "Iosevka Term SS04")
  ...
  (defun kb/default-fonts-setup ()
    ...
    (set-face-attribute 'fixed-pitch nil :font "Hack Nerd Font Mono" :height 140)
    (set-face-attribute 'variable-pitch nil :font "IBM Plex Sans KR" :height 148)
