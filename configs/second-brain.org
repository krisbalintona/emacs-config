...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    :hook (server-after-make-frame . (lambda () (org-roam-mode t)))
    :custom
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam-server
    ...
    (add-hook 'org-roam-server-mode-hook (lambda () (require 'org-protocol))) ; Required to open roam buffers from the server
    )
#+END_SRC
