...
;; `krisb-org-hide-drawers-delete-overlays' then
;; `krisb-org-hide-drawers-create-overlays' is created.  After deletion and
...
(defun krisb-org-hide-drawers-delete-overlays (&optional buffer)
...
If BUFFER is non-nil, delete overlays in that buffer instead."
  ...
  ;; stored in `krisb-org-hide-drawers-overlays' because the overlay objects in
